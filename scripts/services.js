...
/**
 * Fetches the list of topic ids.
 *
 * This is used to generate the paths to the Articles List page when
 * static generating those pages.
 *
 * @returns {Promise({object})} - A Promise containing the data
 */
...
/**
 * Fetch the name of the given topic (used for the breadcrumbs in the
 * Articles List page)
 *
 * @param {string} topicId - the id of the topic whose name is to be obtained
 * @returns {Promise({Object})} - A Promise containing the data
 */
...
/*
 * Gets the list of articles for the specified topic to be used
 * to generate the paths for the Article Details page when
 * static generating those pages.
 */
...
/**
 * Fetches the id and name for all articles for all topics in the system.
 *
 * This is used to generate the paths to the Article Details page when
 * static generating those pages.
 *
 * @returns {Promise({object})} - A Promise containing the data
 */
